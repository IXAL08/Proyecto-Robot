...
namespace Robot
{
    ...
    public class ChipData : ItemData
    {
        ...
        public GUIBonusEffect GUIBonusEffect;
        ...
        private void Reset()
        {
            // Genera la forma autom�ticamente al crear el ScriptableObject
            EnsureShape();
        }

        /// <summary>
        /// Genera la forma predeterminada si la lista est� vac�a
        /// </summary>
